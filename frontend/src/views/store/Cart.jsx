...
function Cart() {
  ...
  // Above API Call to Get cart Items

  // API Call to Get Cart Totals
  ...
  // Above API Call to Get Cart Totals
  ...
  // Above API Call to Remove Item From Cart
              ...
              <section className="">
                <div className="row gx-lg-5 mb-5">
                  ...
                  <div className="col-lg-4 mb-4 mb-md-0">
                    ...
                    <section className="shadow-4 card p-4 rounded-5">
                      <h5 className="mb-4">Apply promo code</h5>
                      <div className="d-flex align-item-center">
                        <input
                          type="text"
                          className="form-control round ne-1"
